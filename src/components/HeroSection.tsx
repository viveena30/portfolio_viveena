    ...
    <section id="hero" className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-gray-50 via-white to-indigo-50">
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        ...
        <div className="flex justify-center space-x-4 mb-8">
          ...
          <a href="https://drive.google.com/file/d/1ieNJaScLndbHgC5VRf7y3b1PDqOOfMBK/view?usp=sharing" className="bg-white border-2 border-indigo-600 text-indigo-600 hover:bg-indigo-600 hover:text-white px-6 py-3 rounded-lg flex items-center space-x-2 transition-all duration-300 hover:scale-105 shadow-md hover-lift">
